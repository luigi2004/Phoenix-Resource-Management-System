...
( '1','22', 'Scrum 1','confrence room','big room with TV','free','happyface.png');
insert into Resources values
( '2','177', 'Scrum 4','meeting room','big room with printer','booked','happyface.png');
insert into Resources values
( '3','14', 'Scrum 2','super room','big room with headphones','free','happyface.png');
insert into Resources values
( '4','12', 'Scrum 6','small room','big room with chairs','free','happyface.png');
insert into Resources values
( '5','12', 'Scrum 8','big room','big room with tables','booked','happyface.png');

insert into Resources values
( '6','22', 'Training 1','training','big room with TV','booked','happyface.png');
insert into Resources values
( '7','177', 'Training 4','training','big room with printer','free','happyface.png');
insert into Resources values
( '8','14', 'Training 2','training','big room with headphones','free','happyface.png');
insert into Resources values
( '9','12', 'Training 6','training','big room with chairs','free','happyface.png');
insert into Resources values
( '10','12', 'Training 8','training','big room with tables','booked','happyface.png');

insert into Resources values
( '11','22', 'Break 1','Break','big room with TV','booked','happyface.png');
insert into Resources values
( '12','177', 'Break 4','Break','big room with printer','free','happyface.png');
insert into Resources values
( '13','14', 'Break 2','Break','big room with headphones','booked','happyface.png');
insert into Resources values
( '14','12', 'Break 6','Break','big room with chairs','free','happyface.png');
insert into Resources values
( '15','12', 'Break 8','Break','big room with tables','booked','happyface.png');


insert into Visitor values
( '1','Tim', 'tim@syntein.con','99999999999','5049999','Visit','Intel');
insert into Visitor values
( '2','Clay', 'Clay@syntein.con','8888888888','2','Visit','Google');
insert into Visitor values
( '3','Mahesh', 'Mahesh@syntein.con','777777777','3','Visit','Amex');
insert into Visitor values
...
insert into Visitor values
( '8','Chris', 'Chris@syntein.con','222222222','8','Visit','OW');
insert into Visitor values
( '9','Zack', 'Xack@syntein.con','121212121','9','Visit','YWA');
insert into Visitor values
( '10','Tom', 'l@syntein.con','4747474747474','10','Visit','YYY');
insert into Visitor values
( '11','Mahesh', 'a@syntein.con','868686868','11','Visit','ZZZ');
...
insert into Users values
( '11','Mahesh', '@syntein.con','868686868','5049929','Visit','ZZZ');
